...
public class BFMediaPlayerControllerVod extends BFMediaPlayerControllerBase {
	...
	public interface OnTimerTicker{
		void onTicker(int i);
	}

	OnTimerTicker mOnTimerTicker;
	public void setTimerTicker(OnTimerTicker listener){
		mOnTimerTicker = listener;
	}
	...
	private void updateProgressBar() {
		...
		mOnTimerTicker.onTicker((int) position);
	...
	protected void doMoveLeft() {
		...
		if (state == STATE.PLAYING || state == STATE.PAUSED) {
			...
			mVodPlayer.seekTo(newPosition  / 1000);
		}
	}
